	...
	<div class="row">
				...
				<div class="vertical-menu">
					<a href="Mmapage.html" >Booking Details</a> 
					 <a href="book.html">Book Seat</a> <a href="swapSeat.html">Swap
						Seat</a> <a href="cancelSeatPage.html" class="active">Cancel Seat</a> <a
			...
			<div class="col-md-9">
				<div class="panel panel-success" style="margin: 1em;">
					...
					<div class="panel-body">Do you really want to cancel booking ? <br> 
						<a href="cancel.html" class="label label-danger"><span>   Yes   </span></a>
						<a href="cancelseatNo.html" class="label label-success"> <span>  No   </span></a> 
					</div>
