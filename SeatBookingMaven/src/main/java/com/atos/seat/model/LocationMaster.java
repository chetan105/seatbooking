...
public class LocationMaster implements Serializable {
	...
	@OneToMany
	@JoinTable(name = "seat_no", joinColumns = @JoinColumn(name = "location_code"), inverseJoinColumns = @JoinColumn(name = "seat_no"))
	private List<SeatMaster> seatMasters = new ArrayList<SeatMaster>();
