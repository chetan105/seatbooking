...
<!-- 				<li>
 ...
 <div class="container" >
      ...
      <label class="control-label col-sm-2" for="seatNo">Seat number:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="seatNo" placeholder="Enter seat number" name="seatNo" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control" id="floorNo" placeholder="Enter floor number" name="floorNo" required>
      </div>
    </div>
	...
	<div class="form-group">
      <label class="control-label col-xs-2" for="seatStatus">Seat status:</label>
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="seatStatus" placeholder="available" value="available" name="seatStatus" disabled>
      </div>
    </div>
