		...
		<div class="row">
			<div class="col-md-2">
				<div class="vertical-menu">
					...
					<a href="file:///C:/Users/Administrator/Desktop/Final%20MMA/mainpage.html">Personal
						Details</a> 
						<a href="contactdetail.html">Contact Details</a>
					 <a href="book.html" class="active">Book Seat</a>
					  <a href="swapSeat.html">Swap Seat</a> 
					  <a href="cancelSeat.html">Cancel Seat</a> 
...
<div class="col-sm-12" style="border:1px solid #000">
	<div class="container">
		<form action="viewseats.html" name="myForm" method="post">

	<div class="row">			
			<div class="col-sm-4">
			<div class="form-group">
      <label class="control-label col-sm-2" for="floorNo">Floor Number:</label>
      <div class="col-sm-10"> 
                  <select name="floorNo" id="floorNo">
       
           <c:forEach items="${data.get(0)}" var="floor">
			...
			<div class="col-sm-4">
			<div class="form-group">
      <label class="control-label col-sm-2" for="Office Name">Office Name:</label>
      <div class="col-sm-10"> 
                  <select name="officeName" id="officeName">
       
           <c:forEach items="${data.get(1)}" var="office">
					<option>${office.getOfficeNo()}</option>
		</c:forEach>
		</select>
		</div>
		</div>
			...
			<c:forEach items="${data.get(2)}" var="office">
	   ...
	   <button type="submit">Submit</button>
		...
		<c:if test="${seat.getSeatStatus() == 'available' }">
			<a  href="booking.html?id=${seat.seatNo}"><button style="width: 20%">${seat.seatNo } Available</button></a>
		</c:if>
		<c:if test="${seat.getSeatStatus() == 'booked' }">
			<button style="width: 20%;background:red;" disabled style="">${seat.seatNo } Booked</button>
		</c:if>
