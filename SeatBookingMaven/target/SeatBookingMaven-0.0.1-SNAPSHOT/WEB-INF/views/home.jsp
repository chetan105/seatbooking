 ...
 In one powerful tool, easily and instantly schedule desks, manage bookings, and find colleagues.</p>
  <button role="tablist" class="menu nav nav-tabs button_on_image" style="top:70%;left:42%;position:absolutel;z-index:99999">Sign in</button>
	...
	<div class="carousel-caption d-none d-md-block text-left ">
        <h3 style="color:white; font-size:36.32px">A Desk to Call Your Own – Anywhere & Anytime.</h3></div>
		<div class="p-paragraph-inslider">
         <p style="color:white; font-size:22px">Fixed or flexible. However you like your desks, Ownspace can organise them and reduce your real estate costs.<br/>
In one powerful tool, easily and instantly schedule desks, manage bookings, and find colleagues.</p> 
  ...
  <div class="carousel-inner">
    <div class="item active img-wrapper">
      <img src="${pageContext.request.contextPath}/resources/img/seat1.jpg" alt="Los Angeles">
    </div>
    ...
    <!-- <div class="item">
	 ...
	 <div class="item">
      <img src="${pageContext.request.contextPath}/resources/img/seat5.jpg" alt="Chicago">
    </div>
	
	 <div class="item">
      <img src="${pageContext.request.contextPath}/resources/img/seat6.jpg" alt="Chicago">
    </div>
  </div>
        ...
        <div class="col-md-3 col-md-3-features">
          <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.3s">
            <div class="align-center"> 
              <div class="icon"> <img src="${pageContext.request.contextPath}/resources/img1/1.png"></div>
			   <h4>Enable More Flexibility</h4>
              <p> However you set up your desks, we help you organize, manage and make them bookable to create a more dynamic work environment. </p>
<!--               <div class="ficon">
		...
		<div class="col-md-3 col-md-3-features">
          <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.3s">
            <div class="align-center">
              <div class="icon"> <img src="${pageContext.request.contextPath}/resources/img1/2.png"></div>
			   <h4>Reduce Your Carbon Footprint</h4>
              <p>Our desk booking solution ensures you maximize the use of your real estate – helping you reduce your energy bill and saving you money.</p>
             <!--  <div class="ficon">
                <a href="" alt="">Learn more</a>
              </div> -->
            </div>
        ...
        <div class="col-md-3 col-md-3-features">
          <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.3s">
            <div class="align-center">
              <div class="icon"> <img src="${pageContext.request.contextPath}/resources/img1/3.png"></div>
			   <h4>Maximize Desk Usage and Minimize Costs</h4>
              <p>With the average office utilization at only 39%, we help you allocate the desks you really need to cut real estate costs.</p>
             <!--  <div class="ficon">
                <a href="" alt="">Learn more</a>
              </div> -->
            </div>
        ...
        <div class="col-md-3 col-md-3-features">
          <div class="wow bounceIn" data-wow-offset="0" data-wow-delay="1.3s">
            <div class="align-center">
                 <div class="icon"> <img src="${pageContext.request.contextPath}/resources/img1/4.png"></div>
				     <h4>Know Your Space Down to the Last Inch</h4>
              <p>Comprehensive reporting provides data on how often desks are booked and if they were actually used. </p>
              <!-- <div class="ficon">
                <a href="" alt="">Learn more</a>
              </div> -->
            </div>
