    ...
    <div class="container">
        <div class="row main">
            ...
            <div class="main-login main-center">
                <form action="reset.html" class="form-horizontal" method="post" name="MyForm" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="cols-sm-10">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control"  ng-model="myEmail" name="email" id="email" placeholder="Enter your email id"  />
                    ...
                    <div class="form-group ">
                        <button type="submit" onclick="validate()" class="btn btn-primary btn-lg btn-block login-button">Submit</button>
                    </div>
                    <!-- SUBMIT BUTTON ENDS -->
