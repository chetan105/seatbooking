		...
		<div class="row">
				<div class="vertical-menu">
					<a
						...
						href="book.html" >Book Seat</a> <a
						href="swapSeat.html" class="active">Swap Seat</a> <a href="cancelSeat.html">Cancel
		...
		<div class="col-md-12" style="border:1px solid #000">
			...
			<div class="form-group">
                    ...
                    <div class="form-group">
					 ...
					 <div class="form-group">
                        <label for="employeeId2" class="cols-sm-2 control-label">Enter Employee_ID to be swapped with</label>
                        <div class="cols-sm-5">
                            <div class="input-group">
                               
                                <input type="text" class="form-control" name="employeeId2" id="employeeId2" placeholder="Enter employee Id " required/>
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        <label for="seatNo2" class="cols-sm-2 control-label">Seat No to be swapped</label>
                        <div class="cols-sm-5">
                            <div class="input-group">
                             
                                <input type="text" class="form-control" name="seatNo2" id="seatNo2" placeholder="Enter seat no" required/>
                            </div>
                        </div>
                    </div>
