    ...
    <div class="container">
        <div class="row main">
            ...
            <div class="main-login main-center">
                <form action="ConfirmDeleteAccount.html" class="form-horizontal" method="post" >
                    ...
                    <div class="form-group ">
                        <button type="submit" onclick="validate()" class="btn btn-primary btn-lg btn-block login-button">Confirm</button>
                    </div>
                    <!-- Confirm BUTTON ENDS -->
